...
public interface UserDao {
    ...
    //根据username password 查找用户
    public User queryUserByNamePwd(@Param("username") String username,@Param("userpwd") String userpwd);
    ...
    //根据username获取用户集数量
    public int getUserCountByname(@Param("username") String username);
}
