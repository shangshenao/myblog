...
public interface UserArticleFavDao {
    //增加用户文章的收藏
    public int insertUserArticleFav(@Param("userid") int userid, @Param("articleid") int articleid);
    //删除用户文章的收藏
    public int deleteUserArticleFav(@Param("userid") int userid,@Param("articleid") int articleid);
    //查询用户收藏的文章
