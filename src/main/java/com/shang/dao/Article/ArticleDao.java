...
public interface ArticleDao {
    ...
    //更改一篇文章数据
    public int updateArticleData(@Param("articleid") int articleid,@Param("viewcount") int viewcount,@Param("likecount") int likecount,@Param("favcount") int favcount,@Param("commentcount") int commentcount) throws Exception;
    //删除一篇文章(逻辑删除)
