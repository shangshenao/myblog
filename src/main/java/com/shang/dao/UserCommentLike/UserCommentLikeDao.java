...
public interface UserCommentLikeDao {
    //增加用户点赞评论记录
    int insertUserCommentLike(@Param("userid") int userid, @Param("commentid") int commentid);
    //删除记录
    int deleteUserCommentLike(@Param("userid") int userid,@Param("commentid") int commentid);
    //按用户查询点赞记录
